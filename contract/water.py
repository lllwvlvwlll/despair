...
DESCRIPTION = 'This smart contract represents one of the core resources for the game, water.'
...
def manifest_metadata() -> NeoMetadata:
    ...
    meta.description = 'This smart contract represents one of the core resources for the game, water.'
    meta.version = "v0.0.1"
    return meta
...
def transfer(from_address: UInt160, to_address: UInt160, amount: int, data: Any) -> bool:
    """
    Transfers an amount of DWATER tokens from one account to another
...
def post_transfer(from_address: Union[UInt160, None], to_address: Union[UInt160, None], amount: int, data: Any):
    """
    Checks if the one receiving DWATER tokens is a smart contract and if it's one the onPayment method will be called
