...
DESCRIPTION = 'This smart contract represents one of the core resources for the game, wheat.'
...
def manifest_metadata() -> NeoMetadata:
    ...
    meta.description = 'This smart contract represents one of the core resources for the game, wheat.'
    meta.version = "v0.0.1"
    return meta
...
def transfer(from_address: UInt160, to_address: UInt160, amount: int, data: Any) -> bool:
    """
    Transfers an amount of DWHEAT tokens from one account to another
