...
var Despair = /** @class */ (function () {
     ...
     * @param contractHash
     */
    Despair.init = function (node, contractHash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = "init";
                        return [4 /*yield*/, interface_1.NeoInterface.TestInvoke(node, contractHash, method, [])];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res];
                }
     ...
     */
    Despair.hello = function (node, contractHash) {
        return __awaiter(this, void 0, void 0, function () {
            var method, res, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        method = "hello";
                    ...
                    case 1:
                        ...
                        value = neon_js_1.default.u.HexString.fromBase64(res[0].value).toAscii();
