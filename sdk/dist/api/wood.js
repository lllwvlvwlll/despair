...
var Wood = /** @class */ (function () {
    ...
    Wood.symbol = function (node, networkMagic, contractHash) {
    ...
    Wood.decimals = function (node, networkMagic, contractHash) {
        return __awaiter(this, void 0, void 0, function () {
            var method, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Wood.totalSupply = function (node, networkMagic, contractHash) {
        return __awaiter(this, void 0, void 0, function () {
            var method, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Wood.balanceOf = function (node, networkMagic, contractHash, address) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Wood.transfer = function (node, networkMagic, contractHash, fromAddress, toAddress, amount, account, data) {
        return __awaiter(this, void 0, void 0, function () {
            var method, params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Wood.mint = function (node, networkMagic, contractHash, address, amount, account) {
        return __awaiter(this, void 0, void 0, function () {
            var method, params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Wood.burn = function (node, networkMagic, contractHash, address, amount, account) {
        return __awaiter(this, void 0, void 0, function () {
            var method, params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Wood.onNEP17Payment = function (node, networkMagic, contractHash, address, amount, data, account) {
        return __awaiter(this, void 0, void 0, function () {
            var method, params, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
